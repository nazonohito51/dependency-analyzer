...
class QualifiedNameMatcherTest extends TestCase
{
    ...
    public function provideIsMatch()
    {
        return [
            ...
            'multi patterns 1' => [['\\Tests\\Fixtures', '\\Tests\\Fixtures\\', '\\Tests\\Integration\\'], 'Tests\\Fixtures', true],
            'multi patterns 2' => [['\\Tests\\Fixtures', '\\Tests\\Fixtures\\', '\\Tests\\Integration\\'], 'Tests\\Fixtures\\SomeClass', true],
            'multi patterns 3' => [['\\Tests\\Fixtures', '\\Tests\\Fixtures\\', '\\Tests\\Integration\\'], 'Tests\\Integration\\SomeClass', true],
