...
class ExtraPhpDocTagResolverTest extends TestCase
{
    ...
    public function testResolveDepsInternalTag()
    {
        ...
        $this->assertTrue($actual[0]->getEqsen()->isClass());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal', $actual[0]->getEqsen()->toString());
        ...
        $this->assertTrue($actual[1]->getEqsen()->isProperty());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::$haveDoc', $actual[1]->getEqsen()->toString());
        $this->assertCount(0, $actual[1]->getTargets());
        $this->assertTrue($actual[2]->getEqsen()->isProperty());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::$haveDocWithOption', $actual[2]->getEqsen()->toString());
        ...
        $this->assertTrue($actual[3]->getEqsen()->isMethod());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::haveDoc()', $actual[3]->getEqsen()->toString());
        $this->assertCount(0, $actual[3]->getTargets());
        $this->assertTrue($actual[4]->getEqsen()->isMethod());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::haveDocWithOption()', $actual[4]->getEqsen()->toString());
        ...
        $this->assertTrue($actual[5]->getEqsen()->isClassConstant());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::HAVE_DOC', $actual[5]->getEqsen()->toString());
        $this->assertCount(0, $actual[5]->getTargets());
        $this->assertTrue($actual[6]->getEqsen()->isClassConstant());
        $this->assertSame('\Tests\Fixtures\ExtraPhpDocs\DepsInternal::HAVE_DOC_WITH_OPTION', $actual[6]->getEqsen()->toString());
